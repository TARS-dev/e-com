  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <div class="dropdown-menu">
        <!-- <a class="dropdown-item" href="show_type.php?act=edit_type">Edit Type</a> -->
        <a class="dropdown-item" href="shop_pro.php?act=add">Add_pro</a>
...
include('form_edit_pro.php');
}elseif ($act == 'add') {
  include('add_pro.php');
}else {
    include('list_pro.php');
}
?>
