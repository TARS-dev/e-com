...
<head>
  ...
  <a href="show_team.php" class="list-group-item list-group-item-action">Team</a>
      ...
      <div class="col-md-8">
      <!-- <a href="show_ad.php?act=add" class="btn-info btn-sm">Add_admin</a> -->
      <h1>Hello admin-><?php echo $_SESSION['User'] ?><-</h1>
      <h2>Welcome to IT_Shop</h2>
      <label>Buy every thing that you think</label>
